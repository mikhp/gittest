...
# 1.数据准备
df = pro.daily(ts_code='300348.SZ', start_date='20200101', end_date='20210311')
...
X = df[['close', 'vol', 'close-open', 'MA5', 'MA10', 'high-low',
...
# 参数调优
parameters = {'n_estimators': [5, 10, 20], 'max_depth': [
    2, 3, 4, 5], 'min_samples_leaf': [5, 10, 20, 30]}
